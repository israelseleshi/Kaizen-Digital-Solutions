                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-12 pr-4 py-3 border-2 border-border focus:border-primary transition-colors"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className="pl-12 pr-12 py-3 border-2 border-border focus:border-primary transition-colors"
